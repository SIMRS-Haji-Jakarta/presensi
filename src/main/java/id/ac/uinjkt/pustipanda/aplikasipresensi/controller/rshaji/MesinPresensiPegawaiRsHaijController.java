...
@Controller
@Slf4j
@RequestMapping("/rshaji/mesin-presensi-pegawai")
public class MesinPresensiPegawaiRsHaijController {
    ...
    public String showList(@RequestParam(value = "nama", required = false) String nama,
        ...
        Page<MesinPresensiPegawai> result = mesinPresensiPegawaiService.getFilterBySearchParamAndPage(nama, namaMesin, unitRsHaji.get(), page);

        mm.addAttribute("nama", nama);
        mm.addAttribute("namamesin", namaMesin);
        mm.addAttribute("data", result);

        return "rshaji/mesin-presensi-pegawai/list";
    }
    ...
    public String showForm(@RequestParam(required = false) String id, ModelMap mm) {
        ...
        return "rshaji/mesin-presensi-pegawai/list :: modalForm";
    }
    ...
    public String updateForm(@ModelAttribute @Valid MesinPresensiPegawaiDto o, BindingResult errors, RedirectAttributes ra,
        ...
        if (errors.hasErrors()) {
            ...
            return "redirect:/rshaji/mesin-presensi-pegawai/list";
        } else {
